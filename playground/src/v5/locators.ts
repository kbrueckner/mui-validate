...
export const ERRORLIST_INPUT1 = locator(['v5', 'errorlist', 'input1'], 'input');
export const ERRORLIST_INPUT2 = locator(['v5', 'errorlist', 'input2'], 'input');
export const ERRORLIST1 = locator(['v5', 'errorlist1'], 'list');
export const ERRORLIST2 = locator(['v5', 'errorlist2'], 'list');
